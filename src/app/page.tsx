  ...
  return (
    <main className="phone-page">
      <AnimatePresence initial={false} mode="popLayout">
        ...
        {stage === "calibrate" && <Screen key={`calibration-${calibrationQuestionIndex}`} className="calibration-screen"><OnboardingCalibration direction={direction} questionIndex={calibrationQuestionIndex} responses={calibrationResponses} onQuestionIndexChange={setCalibrationQuestionIndex} onResponses={recordCalibrationResponses} onBack={() => setStage("direction")} onFinish={() => setStage("preferences")} /></Screen>}
